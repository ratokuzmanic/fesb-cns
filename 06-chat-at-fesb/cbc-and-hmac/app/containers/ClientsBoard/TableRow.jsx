...
const StatusCell = ({ keyStatus, children }) => {
    ...
    if (isGenerating) return  (
        <td style={ {textAlign: 'left'}}>Generating...</td>
    )
...
const ButtonCell = ({ onClick, children }) => (
    <td>
        <div 
            className='ClientsBoard__button'
            onClick={onClick}
        >
            { children }
        </div>
        ...
        return (
            <tr>
                <td className='ClientsBoard__nickname-td'> 
                    <DecoratedLetter 
                        color={color} 
                        letter={client.nickname[0]}
                    />
                
                    <div className='ClientsBoard__nickname-cell'>   
                        {client.nickname}
                    </div>
                </td>
                ...
                <StatusCell keyStatus={symmetric}>
                    No key
                </StatusCell>

                <ButtonCell onClick={this._handleButtonClick}>
                    Delete
                </ButtonCell>
