...
;(async () => {
    try {
        const key = await pbkdf2({secret: 'zelursirronkcuhc'})

        const ciphertext = encrypt({
            mode: 'aes-256-cbc',
            iv: Buffer.from('711324d3dc0ab9508f551f327111ddb9', 'hex'),
            key,
            plaintext: 'ECB: Chuck Norris je zatvorio Otvoreni radio.'
        })
...
;(async () => {
    try {
        ...
        const plaintext = decrypt({
            ...
            iv: Buffer.from('711324d3dc0ab9508f551f327111ddb9', 'hex'),
            key,
            ciphertext: '8e2f59bd9114d626d65a738d1b7860d09e491fff39b120b9c91c49b3b91292153b7642eb440f983104f2ca73bda213f3'
        })
